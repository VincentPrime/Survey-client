...
export default function StudentDashboard() {
  ...
  const loadData = async () => {
    try {
      ...
      const [surveysData, historyData] = await Promise.all([
        surveyService.getSurveys(),
        responseService.getMyHistory(),
      ]);

      setSurveys(surveysData);
      setResponseCount(historyData.length);
    } catch (error) {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-4">
              <Link href="/student/history" className="text-gray-600 hover:text-gray-900 font-medium text-sm">
                My History
              </Link>
              <button
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-200">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-gray-600">Assigned Surveys</p>
          ...
          <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-200">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-green-600 mt-1">{responseCount}</p>
              </div>
          ...
          <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-200">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-gray-900 mt-1">{user?.section || 'N/A'}</p>
              </div>
          ...
          <div className="p-6">
            {surveys.length === 0 ? (
              <div className="text-center py-12">
                ...
                <p className="text-gray-500 text-lg">No surveys assigned yet</p>
              </div>
            ) : (
                ...
                {surveys.map((survey) => (
                  ...
                  >
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        ...
                        <div className="flex items-center space-x-4 text-sm text-gray-500">
                          <span className="flex items-center">
                            ...
                            Due: {survey.due_date ? formatDate(survey.due_date) : 'No deadline'}
                          </span>
                          <span className="flex items-center">
                            <svg className="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                      ...
                      >
                        {isOverdue(survey.due_date) ? 'Overdue' : 'Take Survey'}
                      </Link>
                    </div>
                  </div>
                ))}
