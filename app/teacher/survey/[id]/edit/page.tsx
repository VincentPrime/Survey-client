...
export default function EditSurveyPage() {
  ...
  const loadSurveyData = async () => {
    try {
      ...
      if (survey.due_date) {
        const date = new Date(survey.due_date);
      ...
      setSurveyData({
        ...
        target_sections: survey.target_sections || [],
        target_courses: survey.target_courses || [],
        target_years: survey.target_years || [],
      });
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          <div className="flex items-center justify-center space-x-4">
            ...
            <div className={`flex items-center ${step >= 2 ? 'text-blue-600' : 'text-gray-400'}`}>
              ...
              <span className="ml-2 font-medium">Edit Questions</span>
            </div>
          </div>
        </div>

        {/* Step 1: Survey Details - Copy from create page with same structure */}
        {step === 1 && (
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-8">
            ...
            <div className="space-y-6">
              ...
              {/* Target Audience Section - Same as create page */}
        ...
        {/* Step 2: Edit Questions - Copy structure from create page but show existing questions */}
        {step === 2 && (
          <div className="space-y-6">
            {/* Existing Questions */}
            {questions.length > 0 && (
            ...
            {/* Add New Question Form - Same as create page */}
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-8">
